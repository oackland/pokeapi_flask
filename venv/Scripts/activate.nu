...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\oackland\IdeaProjects\pokeapi_flask\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\oackland\IdeaProjects\pokeapi_flask\venv\Scripts\deactivate.nu'
